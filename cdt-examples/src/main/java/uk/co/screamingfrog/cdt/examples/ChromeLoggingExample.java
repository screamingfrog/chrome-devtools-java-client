...
import uk.co.screamingfrog.cdt.launch.ChromeArguments;
...
/**
 * By setting logger `uk.co.screamingfrog.cdt.launch.chrome.output` to DEBUG level, either
 ...
 *
 * <p>Logger `uk.co.screamingfrog.cdt.launch.chrome.output` can be set to DEBUG level
 * programmatically as in an example below (enableDebugChromeOutput method) or by introducing
 *
 * <pre>
 *   <logger name="uk.co.screamingfrog.cdt.launch.chrome.output" level="DEBUG" />
 * </pre>
 *
...
public class ChromeLoggingExample {
  ...
  /**
   * Programmatically set `uk.co.screamingfrog.cdt.launch.chrome.output` to DEBUG level so chrome
   * output can be observed.
   */
  private static void enableDebugChromeOutput() {
    LoggerContext loggerContext = (LoggerContext) LoggerFactory.getILoggerFactory();
    loggerContext.getLogger("uk.co.screamingfrog.cdt.launch.chrome.output").setLevel(Level.DEBUG);
  }
