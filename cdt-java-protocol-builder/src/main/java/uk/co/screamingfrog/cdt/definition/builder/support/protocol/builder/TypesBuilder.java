...
import static uk.co.screamingfrog.cdt.definition.builder.support.utils.StringUtils.*;
...
import uk.co.screamingfrog.cdt.definition.builder.support.java.builder.*;
...
import uk.co.screamingfrog.cdt.definition.builder.support.protocol.builder.support.PropertyHandlerResult;
import uk.co.screamingfrog.cdt.definition.builder.support.protocol.builder.support.TypeBuildRequest;
...
import uk.co.screamingfrog.cdt.protocol.definition.types.type.object.properties.*;
import uk.co.screamingfrog.cdt.protocol.definition.types.type.object.properties.array.ArrayItem;
import uk.co.screamingfrog.cdt.protocol.definition.types.type.object.properties.array.items.*;
...
public class TypesBuilder {
  ...
  static {
    registerTypeArrayItem(
        uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.StringArrayItem.class,
        "String");
    registerTypeArrayItem(
        uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.NumberArrayItem.class,
        "Double");
    registerTypeArrayItem(
        uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.IntegerArrayItem.class,
        "Integer");
  }
  ...
  protected String addRefImportStatement(
    ...
    if (isArrayType(type)) {
      ...
      if (isRefArrayItemType(arrayType.getItems())) {
        uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.RefArrayItem
            refArrayItem =
                (uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.RefArrayItem)
                    arrayType.getItems();
  ...
  protected static boolean isRefArrayItemType(
      uk.co.screamingfrog.cdt.protocol.definition.types.type.array.ArrayItem arrayItem) {
    return arrayItem
        instanceof uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.RefArrayItem;
  }
   ...
   * @param <T> Array item class type.
   */
  private static <T extends uk.co.screamingfrog.cdt.protocol.definition.types.type.array.ArrayItem>
