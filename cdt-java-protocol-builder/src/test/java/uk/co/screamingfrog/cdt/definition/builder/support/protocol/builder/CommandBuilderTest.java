...
import static uk.co.screamingfrog.cdt.definition.builder.support.protocol.builder.CommandBuilder.buildReturnClasses;
...
import uk.co.screamingfrog.cdt.definition.builder.support.java.builder.support.MethodParam;
import uk.co.screamingfrog.cdt.definition.builder.support.protocol.builder.support.DomainTypeResolver;
import uk.co.screamingfrog.cdt.protocol.definition.types.Command;
import uk.co.screamingfrog.cdt.protocol.definition.types.Domain;
import uk.co.screamingfrog.cdt.protocol.definition.types.Event;
...
import uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.StringArrayItem;
...
public class CommandBuilderTest extends EasyMockSupport {
  ...
  public void testBuildCommandWithMethodWithArrayRefParam() {
    ...
    final uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.RefArrayItem
        refArrayItem =
            new uk.co.screamingfrog.cdt.protocol.definition.types.type.array.items.RefArrayItem();
  ...
  public void testBuildCommandWithMethodWithStringTypedReturnParams() {
    ...
    arrayStringProperty.setItems(
        new uk.co.screamingfrog.cdt.protocol.definition.types.type.object.properties.array.items
            .StringArrayItem());
