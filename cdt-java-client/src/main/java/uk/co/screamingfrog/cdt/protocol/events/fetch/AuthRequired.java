package uk.co.screamingfrog.cdt.protocol.events.fetch;
...
import uk.co.screamingfrog.cdt.protocol.types.fetch.AuthChallenge;
import uk.co.screamingfrog.cdt.protocol.types.network.Request;
import uk.co.screamingfrog.cdt.protocol.types.network.ResourceType;
