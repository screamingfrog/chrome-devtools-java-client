package uk.co.screamingfrog.cdt.services.impl;
...
import static uk.co.screamingfrog.cdt.services.impl.utils.WebSocketUtils.isTyrusBufferOverflowCloseReason;
import static uk.co.screamingfrog.cdt.services.utils.ConfigurationUtils.systemProperty;
...
import uk.co.screamingfrog.cdt.services.WebSocketService;
import uk.co.screamingfrog.cdt.services.exceptions.WebSocketServiceException;
import uk.co.screamingfrog.cdt.services.factory.WebSocketContainerFactory;
import uk.co.screamingfrog.cdt.services.factory.impl.DefaultWebSocketContainerFactory;
...
public class WebSocketServiceImpl implements WebSocketService {
  public static final String WEB_SOCKET_CONTAINER_FACTORY_PROPERTY =
      "uk.co.screamingfrog.cdt.services.config.webSocketContainerFactory";
   ...
   * uk.co.screamingfrog.cdt.services.config.webSocketContainerProvider. The default value for this
    ...
    try {
      ...
      throw new RuntimeException(
          containerFactoryClassName
              + " does not implement uk.co.screamingfrog.cdt.services.factory.WebSocketContainerFactory interface.");
