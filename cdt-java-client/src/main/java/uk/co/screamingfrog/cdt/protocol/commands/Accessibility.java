...
import uk.co.screamingfrog.cdt.protocol.events.accessibility.LoadComplete;
import uk.co.screamingfrog.cdt.protocol.events.accessibility.NodesUpdated;
...
import uk.co.screamingfrog.cdt.protocol.types.accessibility.AXNode;
...
public interface Accessibility {
   ...
   * @param frameId The frame for whose document the AX tree should be retrieved. If omitted, the
   *     root frame is used.
   */
  @Experimental
  @Returns("nodes")
