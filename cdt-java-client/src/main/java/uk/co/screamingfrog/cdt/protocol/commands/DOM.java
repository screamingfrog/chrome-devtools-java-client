...
import uk.co.screamingfrog.cdt.protocol.events.dom.AttributeModified;
import uk.co.screamingfrog.cdt.protocol.events.dom.AttributeRemoved;
import uk.co.screamingfrog.cdt.protocol.events.dom.CharacterDataModified;
import uk.co.screamingfrog.cdt.protocol.events.dom.ChildNodeCountUpdated;
import uk.co.screamingfrog.cdt.protocol.events.dom.ChildNodeInserted;
import uk.co.screamingfrog.cdt.protocol.events.dom.ChildNodeRemoved;
import uk.co.screamingfrog.cdt.protocol.events.dom.DistributedNodesUpdated;
import uk.co.screamingfrog.cdt.protocol.events.dom.DocumentUpdated;
...
import uk.co.screamingfrog.cdt.protocol.events.dom.TopLayerElementsUpdated;
