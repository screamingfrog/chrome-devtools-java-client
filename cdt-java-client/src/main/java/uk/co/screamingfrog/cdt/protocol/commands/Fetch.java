...
import uk.co.screamingfrog.cdt.protocol.types.fetch.AuthChallengeResponse;
import uk.co.screamingfrog.cdt.protocol.types.fetch.HeaderEntry;
import uk.co.screamingfrog.cdt.protocol.types.fetch.RequestPattern;
import uk.co.screamingfrog.cdt.protocol.types.fetch.ResponseBody;
