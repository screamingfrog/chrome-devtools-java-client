...
public enum DeprecationIssueType {
  ...
  @JsonProperty("IdentityInCanMakePaymentEvent")
  ...
  @JsonProperty("NavigateEventRestoreScroll")
  NAVIGATE_EVENT_RESTORE_SCROLL,
  @JsonProperty("NavigateEventTransitionWhile")
  ...
  @JsonProperty("OpenWebDatabaseInsecureContext")
  OPEN_WEB_DATABASE_INSECURE_CONTEXT,
  @JsonProperty("OverflowVisibleOnReplacedElement")
  OVERFLOW_VISIBLE_ON_REPLACED_ELEMENT,
  @JsonProperty("PersistentQuotaType")
