...
import uk.co.screamingfrog.cdt.protocol.events.browser.DownloadProgress;
import uk.co.screamingfrog.cdt.protocol.events.browser.DownloadWillBegin;
...
import uk.co.screamingfrog.cdt.protocol.types.browser.Bounds;
import uk.co.screamingfrog.cdt.protocol.types.browser.BrowserCommandId;
import uk.co.screamingfrog.cdt.protocol.types.browser.Histogram;
