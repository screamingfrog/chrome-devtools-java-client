...
import uk.co.screamingfrog.cdt.protocol.events.target.AttachedToTarget;
import uk.co.screamingfrog.cdt.protocol.events.target.DetachedFromTarget;
import uk.co.screamingfrog.cdt.protocol.events.target.ReceivedMessageFromTarget;
import uk.co.screamingfrog.cdt.protocol.events.target.TargetCrashed;
import uk.co.screamingfrog.cdt.protocol.events.target.TargetCreated;
import uk.co.screamingfrog.cdt.protocol.events.target.TargetDestroyed;
import uk.co.screamingfrog.cdt.protocol.events.target.TargetInfoChanged;
