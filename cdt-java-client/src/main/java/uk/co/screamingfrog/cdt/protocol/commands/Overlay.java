...
import uk.co.screamingfrog.cdt.protocol.events.overlay.InspectModeCanceled;
import uk.co.screamingfrog.cdt.protocol.events.overlay.InspectNodeRequested;
import uk.co.screamingfrog.cdt.protocol.events.overlay.NodeHighlightRequested;
import uk.co.screamingfrog.cdt.protocol.events.overlay.ScreenshotRequested;
...
import uk.co.screamingfrog.cdt.protocol.types.dom.RGBA;
import uk.co.screamingfrog.cdt.protocol.types.overlay.ColorFormat;
import uk.co.screamingfrog.cdt.protocol.types.overlay.ContainerQueryHighlightConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.FlexNodeHighlightConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.GridNodeHighlightConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.HighlightConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.HingeConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.InspectMode;
import uk.co.screamingfrog.cdt.protocol.types.overlay.IsolatedElementHighlightConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.ScrollSnapHighlightConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.SourceOrderConfig;
import uk.co.screamingfrog.cdt.protocol.types.overlay.WindowControlsOverlayConfig;
