...
import uk.co.screamingfrog.cdt.protocol.types.domdebugger.CSPViolationType;
import uk.co.screamingfrog.cdt.protocol.types.domdebugger.DOMBreakpointType;
import uk.co.screamingfrog.cdt.protocol.types.domdebugger.EventListener;
