package uk.co.screamingfrog.cdt.services.config;
...
import uk.co.screamingfrog.cdt.services.executors.DefaultEventExecutorService;
import uk.co.screamingfrog.cdt.services.executors.EventExecutorService;
import uk.co.screamingfrog.cdt.services.utils.ConfigurationUtils;
...
public class ChromeDevToolsServiceConfiguration {
  private static final String READ_TIMEOUT_PROPERTY =
      "uk.co.screamingfrog.cdt.services.config.readTimeout";
