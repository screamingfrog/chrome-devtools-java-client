...
import uk.co.screamingfrog.cdt.protocol.events.debugger.BreakpointResolved;
import uk.co.screamingfrog.cdt.protocol.events.debugger.Paused;
import uk.co.screamingfrog.cdt.protocol.events.debugger.Resumed;
import uk.co.screamingfrog.cdt.protocol.events.debugger.ScriptFailedToParse;
import uk.co.screamingfrog.cdt.protocol.events.debugger.ScriptParsed;
...
import uk.co.screamingfrog.cdt.protocol.types.debugger.BreakLocation;
import uk.co.screamingfrog.cdt.protocol.types.debugger.ContinueToLocationTargetCallFrames;
import uk.co.screamingfrog.cdt.protocol.types.debugger.DisassembleWasmModule;
import uk.co.screamingfrog.cdt.protocol.types.debugger.EvaluateOnCallFrame;
import uk.co.screamingfrog.cdt.protocol.types.debugger.Location;
import uk.co.screamingfrog.cdt.protocol.types.debugger.LocationRange;
import uk.co.screamingfrog.cdt.protocol.types.debugger.RestartFrame;
import uk.co.screamingfrog.cdt.protocol.types.debugger.RestartFrameMode;
import uk.co.screamingfrog.cdt.protocol.types.debugger.ScriptPosition;
import uk.co.screamingfrog.cdt.protocol.types.debugger.ScriptSource;
import uk.co.screamingfrog.cdt.protocol.types.debugger.SearchMatch;
import uk.co.screamingfrog.cdt.protocol.types.debugger.SetBreakpoint;
import uk.co.screamingfrog.cdt.protocol.types.debugger.SetBreakpointByUrl;
import uk.co.screamingfrog.cdt.protocol.types.debugger.SetInstrumentationBreakpointInstrumentation;
import uk.co.screamingfrog.cdt.protocol.types.debugger.SetPauseOnExceptionsState;
import uk.co.screamingfrog.cdt.protocol.types.debugger.SetScriptSource;
import uk.co.screamingfrog.cdt.protocol.types.debugger.WasmDisassemblyChunk;
import uk.co.screamingfrog.cdt.protocol.types.runtime.CallArgument;
