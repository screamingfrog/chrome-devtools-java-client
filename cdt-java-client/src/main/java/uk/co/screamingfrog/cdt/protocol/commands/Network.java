...
import uk.co.screamingfrog.cdt.protocol.events.network.RequestIntercepted;
import uk.co.screamingfrog.cdt.protocol.events.network.RequestServedFromCache;
...
import uk.co.screamingfrog.cdt.protocol.events.network.SubresourceWebBundleInnerResponseParsed;
import uk.co.screamingfrog.cdt.protocol.events.network.SubresourceWebBundleMetadataError;
import uk.co.screamingfrog.cdt.protocol.events.network.SubresourceWebBundleMetadataReceived;
import uk.co.screamingfrog.cdt.protocol.events.network.TrustTokenOperationDone;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketClosed;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketCreated;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketFrameError;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketFrameReceived;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketFrameSent;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketHandshakeResponseReceived;
import uk.co.screamingfrog.cdt.protocol.events.network.WebSocketWillSendHandshakeRequest;
import uk.co.screamingfrog.cdt.protocol.events.network.WebTransportClosed;
import uk.co.screamingfrog.cdt.protocol.events.network.WebTransportConnectionEstablished;
import uk.co.screamingfrog.cdt.protocol.events.network.WebTransportCreated;
...
import uk.co.screamingfrog.cdt.protocol.types.network.AuthChallengeResponse;
import uk.co.screamingfrog.cdt.protocol.types.network.ConnectionType;
...
import uk.co.screamingfrog.cdt.protocol.types.network.LoadNetworkResourceOptions;
import uk.co.screamingfrog.cdt.protocol.types.network.LoadNetworkResourcePageResult;
import uk.co.screamingfrog.cdt.protocol.types.network.RequestPattern;
import uk.co.screamingfrog.cdt.protocol.types.network.ResponseBody;
import uk.co.screamingfrog.cdt.protocol.types.network.ResponseBodyForInterception;
import uk.co.screamingfrog.cdt.protocol.types.network.SecurityIsolationStatus;
