...
import uk.co.screamingfrog.cdt.protocol.events.emulation.VirtualTimeBudgetExpired;
...
import uk.co.screamingfrog.cdt.protocol.types.emulation.DevicePosture;
...
import uk.co.screamingfrog.cdt.protocol.types.emulation.SensorType;
import uk.co.screamingfrog.cdt.protocol.types.emulation.SetEmitTouchEventsForMouseConfiguration;
import uk.co.screamingfrog.cdt.protocol.types.emulation.SetEmulatedVisionDeficiencyType;
import uk.co.screamingfrog.cdt.protocol.types.emulation.UserAgentMetadata;
import uk.co.screamingfrog.cdt.protocol.types.emulation.VirtualTimePolicy;
