...
import uk.co.screamingfrog.cdt.protocol.events.runtime.BindingCalled;
import uk.co.screamingfrog.cdt.protocol.events.runtime.ConsoleAPICalled;
import uk.co.screamingfrog.cdt.protocol.events.runtime.ExceptionRevoked;
import uk.co.screamingfrog.cdt.protocol.events.runtime.ExceptionThrown;
import uk.co.screamingfrog.cdt.protocol.events.runtime.ExecutionContextCreated;
import uk.co.screamingfrog.cdt.protocol.events.runtime.ExecutionContextDestroyed;
import uk.co.screamingfrog.cdt.protocol.events.runtime.ExecutionContextsCleared;
import uk.co.screamingfrog.cdt.protocol.events.runtime.InspectRequested;
...
import uk.co.screamingfrog.cdt.protocol.types.runtime.AwaitPromise;
import uk.co.screamingfrog.cdt.protocol.types.runtime.CallArgument;
import uk.co.screamingfrog.cdt.protocol.types.runtime.CallFunctionOn;
import uk.co.screamingfrog.cdt.protocol.types.runtime.CompileScript;
...
import uk.co.screamingfrog.cdt.protocol.types.runtime.HeapUsage;
import uk.co.screamingfrog.cdt.protocol.types.runtime.Properties;
import uk.co.screamingfrog.cdt.protocol.types.runtime.RemoteObject;
import uk.co.screamingfrog.cdt.protocol.types.runtime.RunScript;
...
public interface Runtime {
   ...
   * @param generateWebDriverValue Whether the result should be serialized according to
