...
import uk.co.screamingfrog.cdt.protocol.events.media.PlayerErrorsRaised;
import uk.co.screamingfrog.cdt.protocol.events.media.PlayerEventsAdded;
import uk.co.screamingfrog.cdt.protocol.events.media.PlayerMessagesLogged;
import uk.co.screamingfrog.cdt.protocol.events.media.PlayerPropertiesChanged;
import uk.co.screamingfrog.cdt.protocol.events.media.PlayersCreated;
