...
import uk.co.screamingfrog.cdt.protocol.events.tracing.BufferUsage;
import uk.co.screamingfrog.cdt.protocol.events.tracing.DataCollected;
import uk.co.screamingfrog.cdt.protocol.events.tracing.TracingComplete;
...
import uk.co.screamingfrog.cdt.protocol.types.tracing.MemoryDumpLevelOfDetail;
import uk.co.screamingfrog.cdt.protocol.types.tracing.RequestMemoryDump;
import uk.co.screamingfrog.cdt.protocol.types.tracing.StartTransferMode;
import uk.co.screamingfrog.cdt.protocol.types.tracing.StreamCompression;
import uk.co.screamingfrog.cdt.protocol.types.tracing.StreamFormat;
import uk.co.screamingfrog.cdt.protocol.types.tracing.TraceConfig;
import uk.co.screamingfrog.cdt.protocol.types.tracing.TracingBackend;
