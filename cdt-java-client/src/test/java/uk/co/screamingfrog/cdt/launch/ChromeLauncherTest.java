package uk.co.screamingfrog.cdt.launch;
...
import uk.co.screamingfrog.cdt.launch.ChromeLauncher.Environment;
import uk.co.screamingfrog.cdt.launch.ChromeLauncher.ShutdownHookRegistry;
import uk.co.screamingfrog.cdt.launch.config.ChromeLauncherConfiguration;
import uk.co.screamingfrog.cdt.launch.exceptions.ChromeProcessTimeoutException;
import uk.co.screamingfrog.cdt.launch.support.ProcessLauncher;
import uk.co.screamingfrog.cdt.launch.utils.LogCollector;
import uk.co.screamingfrog.cdt.services.ChromeService;
import uk.co.screamingfrog.cdt.services.impl.ChromeServiceImpl;
import uk.co.screamingfrog.cdt.utils.FilesUtils;
...
public class ChromeLauncherTest extends EasyMockSupport {
  ...
  public void testLaunchWithDebugLogging()
    ...
    registerAppenderOnDebugLogger(
        "uk.co.screamingfrog.cdt.launch.chrome.output", Level.DEBUG, loggingEvents);
  ...
  public void testLaunchWithErrorLoggingDoesNotLogAnything()
    ...
    List<String> loggingEvents = new ArrayList<>();
    registerAppenderOnDebugLogger(
        "uk.co.screamingfrog.cdt.launch.chrome.output", Level.ERROR, loggingEvents);
